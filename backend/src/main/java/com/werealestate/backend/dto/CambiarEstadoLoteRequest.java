 ...
 * así queda un dato estructurado y buscable, no solo enterrado en la nota libre. montoApartado es
 * obligatorio (y debe ser mayor a 0) solo cuando estado == APARTADO_CON_DINERO. */
